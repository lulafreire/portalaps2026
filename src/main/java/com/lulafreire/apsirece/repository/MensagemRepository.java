...
public interface MensagemRepository extends JpaRepository<Mensagem, Long> {
        ...
        @Query("SELECT m FROM Mensagem m JOIN FETCH m.remetente LEFT JOIN FETCH m.grupo WHERE m.grupo.id = :id ORDER BY m.dataEnvio ASC")
        List<Mensagem> findByGrupoIdCompleto(@Param("id") Long id);
